...
try:
    ...
    print "You need to have PyQT installed to run Electrum-AUR in graphical mode."
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter an Auroracoin address or contact"))
    ...
    def the_website(self):
        webbrowser.open("http://auroracoin.is")
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your Auroracoin address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum-AUR - " + _("Receive Auroracoin payment"))
